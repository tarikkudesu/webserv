...
ErrorResponse::ErrorResponse( int code, String error ) :
__code( code ),
...
void	ErrorResponse::buildResponseBody()
{
	...
	std::stringstream	ss;
	ss << this->__code;
	ErrorResponse::replaceString(this->__Body, "CODE", ss.str());
	ErrorResponse::replaceString(this->__Body, "REASON_PHRASE", this->__reasonPhrase);
	ErrorResponse::replaceString(this->__Body, "MESSAGE", this->__errorIndication);
}
